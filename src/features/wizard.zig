...
pub const slides = [_]Slide{
    ...
    .{
        ...
        \\• если холостая — <i>когда началась и когда закончится</i>
        \\• ближайший холостой период: <i>с … по …</i> и сколько он длится
        \\
    ...
    .{
        ...
        \\• ближайший ретро-период: <i>с … по …</i> — через сколько
        \\  начнётся, когда закончится и сколько длится
    ...
    .{
        ...
        \\
        \\<b>Лунные сутки по Глобе</b> (русская школа):
    ...
    .{
        ...
        \\
        \\В ответе:
        \\• лунный день по титхи и лунные сутки по Глобе
        \\  (та самая система «от восхода до восхода»)
